...
module.exports.run = async (client, message, args, durum, kanal) => {
    ...
    if(!isim) return message.reply(`${client.emojis.cache.find(x => x.name == "wex_cancel")} Geçerli bir isim belirt ve tekrar dene.`).then(e => setTimeout(() => e.delete().catch(() => { }), 15000))
