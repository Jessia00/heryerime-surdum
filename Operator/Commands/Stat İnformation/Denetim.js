const { ButtonStyle, SlashCommandBuilder, PermissionsBitField, EmbedBuilder, IntegrationApplication, ActionRowBuilder, ButtonBuilder } = Discord = require("discord.js");
...
`)
.addFields([{name: `Mesaj Bilgileri`,value: `Mesaj: \`${mesaj} (${(mesaj*mesajPuan).toFixed(0)} +Puan)\``,}])
.addFields([{name: `Diğer Bilgiler`,value: `Yetkili: \`${yetkili} (${yetkili*yetkiliPuan} +Puan)\`
