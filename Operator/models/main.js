...
menu.reply.edit(isimgeçmişiEmbed)
  ...
  Stat.findOne({
      ...
      }).map((x, index) => `${client.emojis.cache.find(x => x.name === "wex_circle")} ${menu.guild.channels.cache.get(x) ? menu.guild.channels.cache.get(x).name : "#kanal-bulunamadı"} \`${client.convertDuration(data.voiceCategory[x])}\``).join("\n");
      ...
      }).map((x, index) => `${client.emojis.cache.find(x => x.name === "wex_circle")} #${menu.guild.channels.cache.get(x) ? menu.guild.channels.cache.get(x).name : "#kanal-bulunamadı"} \`${client.convertDuration(data.voiceChannel[x])}\``).join("\n");
      ...
      }).map((x, index) => `${client.emojis.cache.find(x => x.name === "wex_circle")} #${menu.guild.channels.cache.get(x) ? menu.guild.channels.cache.get(x).name : "#kanal-bulunamadı"} \`${data.messageChannel[x]} mesaj\``).join("\n");
