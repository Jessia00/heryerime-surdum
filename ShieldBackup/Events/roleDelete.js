...
const newRole = await role.guild.roles.create({
  ...
  let kanalPermVeri = data.channelOverwrites.filter(e => client.guilds.cache.get(conf.sunucuId).channels.cache.get(e.id))
...
\`•\` Yapılan İşlem: **Kişi sunucudan kicklendi, Roller eski üyelerine dağıtılmaya başlanıyor..`)
