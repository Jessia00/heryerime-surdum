...
logs(client);
let BackRolesData = require("./models/backRoles")
...
client.login(mainSettings.SHIELDBACKUP).catch(err => console.log("Token bozulmuş lütfen yeni bir token girmeyi dene"));
